                ...
                <div class="col-lg-12">
                    <div class="panel panel-warning">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <form method="post" class="form-horizontal" action="{{ route('fm_art.store') }}">
                                    @csrf
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label col-md-3" for="marque">Famille Article :</label>
                                            <div class="col-md-9">
                                                <input type="text" name="FamArt_Type" class="form-control" id="marque" placeholder="Ajouter votre Famille article">
                                            </div>
                                        </div>
