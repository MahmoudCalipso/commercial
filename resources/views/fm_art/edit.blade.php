                ...
                <div class="col-lg-12">
                    <div class="panel panel-warning">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <form method="post" action="{{ route('fm_art.update', $fm_Article->FamArt_Id) }}">
                                    @csrf
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label col-md-3" for="marque">Famille Article :</label>
                                            <div class="col-md-9">
                                                <input type="text" name="FamArt_Type" class="form-control" id="marque" value="{{$fm_Article->FamArt_Type}}">
                                            </div>
                                        </div>
