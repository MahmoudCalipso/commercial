                    ...
                    <div class="panel panel-success filterable" style="overflow:auto;">
                        ...
                        <div class="panel-body table-responsive">
                            <table class="table table-striped table-bordered" id="table2">
                                ...
                                <tbody>
                                @foreach($famArts as $famArt)
                                <tr>
                                    <td>{{$famArt->FamArt_Id}}</td>
                                    <td>{{$famArt->FamArt_Type}}</td>
                                    <td>

                                        <a  href="{{route('fm_art.edit',$famArt->FamArt_Id)}}" class="btn btn-success">
                                            <span class="livicon" data-name="pen" data-size="20" data-loop="true" data-c="#fff" data-hc="white"></span>
                                        </a>

                                        <a href="{{route('fm_art.delete',$famArt->FamArt_Id)}}" class="btn btn-danger" role="button">
