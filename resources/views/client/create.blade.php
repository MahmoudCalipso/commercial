                ...
                <ul class="page-sidebar-menu" id="menu">
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a href="form_builder.html">
                                    <i class="fa fa-angle-double-right"></i> Liste Client
                                </a>
                            </li>
                            <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a href="form_examples.html">
                                    <i class="fa fa-angle-double-right"></i> Liste Fournisseur
                                </a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="#">
                            ...
                            <span class="title">Gestion Article</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="sub-menu">
                            <li>
                                <a href="animatedicons.html">
                                    <i class="fa fa-angle-double-right"></i> Liste Article
                                </a>
                            </li>
                            <li>
                                <a href="buttons.html">
                            ...
                            <li>
                                <a href="panels.html">
                                    <i class="fa fa-angle-double-right"></i> Liste Marque
                                </a>
                            </li>
                            <li>
                                <a href="icon.html">
                            ...
                            <li>
                                <a href="color.html">
                                    <i class="fa fa-angle-double-right"></i> Liste Famille Article
                                </a>
                            </li>
                            <li>
                                <a href="grid.html">
                                    <i class="fa fa-angle-double-right"></i>  Ajout Famille Article
                                </a>
                            </li>
