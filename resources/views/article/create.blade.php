                                            ...
                                            <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="number" name="QteMax" class="form-control" id="qteArt" placeholder="Qte Articles">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" name="Art_DateAchat" class="form-control" id="rangepicker4" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" name="Pays" class="form-control" id="PyArt" placeholder="Pays Article">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="input-group select2-bootstrap-append">
                                                                    <select id="select23" name="FamArt_Id" class="form-control">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="input-group select2-bootstrap-append">
                                                                    <select id="select24" name="Mag_Id" class="form-control">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3">Block Article:</label>
                                                               ...
                                                               <label>Oui <input type="radio" name="Art_Bloquer" value="1"/></label>
                                                               <label>Non <input type="radio" name="Art_Bloquer" value="0"/></label>
                                            ...
                                            <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="input-group select2-bootstrap-append">
                                                                    <select id="select22" class="form-control">
