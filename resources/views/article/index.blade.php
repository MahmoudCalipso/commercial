                        ...
                        <div class="panel-body table-responsive">
                            <table class="table table-striped table-bordered" id="table2">
                                ...
                                @foreach($articles as $articles)
                                    <tr>
                                        <td>{{$typeArt->Art_Id}}</td>
                                        <td>{{$typeArt->Art_Designation}}</td>
                                        <td><img src="{{$typeArt->Art_Designation}}" style="width: 30px;height: 30px;border-radius: 20px"></td>
                                        <td>{{$typeArt->QteMax}}</td>
                                        <td>{{$typeArt->Art_DateAchat}}</td>
                                        <td>{{$typeArt->ArtRv_HT}}</td>
                                        <td>{{$typeArt->ArtRv_TTC}}</td>
                                        <td>{{$typeArt->Art_HT}}</td>
                                        <td>{{$typeArt->Art_TTC}}</td>

                                        <td>

                                            <a href="{{route('article.edit',$article->Art_Id)}}" class="btn btn-success">
                                                <span class="livicon" data-name="pen" data-size="20" data-loop="true" data-c="#fff" data-hc="white"></span>
                                            </a>

                                            <a href="{{route('article.delete',$article->Art_Id)}}" class="btn btn-danger" role="button">
