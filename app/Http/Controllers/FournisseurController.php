...
class FournisseurController extends Controller
{
    ...
    public function index()
    {
       // $fourns = Fournisseur::all();
        ...
        return view('fournisseur.index', compact('fourns'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $fournisseur = new Fournisseur([
            ...
            'Four_tel' => $request->get('four_tel'),
            'TypeFrs_Intitule' => $request->get('four_type')

        ]);
        $fournisseur->save();
        return redirect('fournisseurs')->with('success', 'Fournisseur saved!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $four->Four_tel = $request->get('four_tel');
        $four->TypeFrs_Intitule = $request->get('four_type');
        $four->save();

        return redirect('fournisseurs')->with('success', 'Fournisseur Updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        return view('fournisseur.index')->with('success', 'Fournisseur deleted!');
    }
}
