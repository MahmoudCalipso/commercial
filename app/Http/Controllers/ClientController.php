...
class ClientController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        'CumuleFidelite' => $request->get('clt_cumul')
        ]);
        $client->save();
    ...
    public function update(Request $request, $id)
    {
        ...
        $client->CumuleFidelite = $request->get('clt_cumul');
        $client->save();

        return view('client.index')->with('success', 'Client updated!');
    }
